	...
	draw((0.3,0.4,0)--(0.3,0.4,0.5),linewidth(0.8pt)+darkgrey+dashed);
	dot((0.3,0.4,0.5),linewidth(6pt));
dot((0.7,0.4,0),linewidth(6pt));
	draw((0.7,0.4,0)--(0.3,0.4,0.5),linewidth(0.8pt)+darkgrey,Arrow3);
